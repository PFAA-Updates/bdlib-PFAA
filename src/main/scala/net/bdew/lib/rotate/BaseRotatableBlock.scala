...
trait BaseRotatableBlock extends Block {
  ...
  /** Override this method to provide your textures, also called when rendering
    * as item
    */
  def getIcon(meta: Int, kind: IconType.Value): IIcon

  /** Override this method to provide your textures, if you need to check other
    * state
    */
  def getIcon(
      world: IBlockAccess,
      ...
      z: Int,
      kind: IconType.Value
  ): IIcon = getIcon(world.getBlockMetadata(x, y, z), kind)
  ...
  override def getIcon(side: Int, meta: Int): IIcon =
    getIcon(meta, IconType.fromSideAndDir(side, getDefaultFacing))
  ...
  override def getIcon(
    ...
    y,
    z,
    IconType.fromSideAndDir(side, getFacing(world, x, y, z))
  )
  ...
  override def getValidRotations(
    ...
    getValidFacings.toArray(Array.empty[ForgeDirection])
  ...
  override def onBlockPlacedBy(
    ...
    val dir =
      RotatedHelper.getFacingFromEntity(ent, getValidFacings, getDefaultFacing)
