...
/** Base class for data slots that hold numeric values adds convenience
  * operators to modify the value
  */

abstract class DataSlotNumeric[T](default: T)(implicit n: Numeric[T])
