...
object DecFormat {
  ...
  def short(x: Double) = (if (x > 10) thousandsFmt.format(x)
                          else if (x > 1) dec1Fmt.format(x)
                          else dec2Fmt.format(x)).replace('\u00A0', ' ')
  def short(x: Float) = (if (x > 10) thousandsFmt.format(x)
                         else if (x > 1) dec1Fmt.format(x)
                         else dec2Fmt.format(x)).replace('\u00A0', ' ')
  def short(x: Int) = (if (x > 10) thousandsFmt.format(x)
                       else if (x > 1) dec1Fmt.format(x)
                       else dec2Fmt.format(x)).replace('\u00A0', ' ')
}
